                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            ...
                            <p class="text-lead text-white">Sign in to the service and continue monitoring your goals and achievements right now</p>
<!--                            <p class="text-lead text-white">Register in the service and start monitoring your goals and achievements right now</p>-->
                        </div>
                    </div>
                </div>
            </div>
